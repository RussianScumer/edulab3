...
def plot_data():
    ...
    # Очищаем графики
    plt.clf()
    plt.figure(figsize=(12, 10))  # Увеличиваем размер фигуры для лучшего отображения

    # Визуализируем количество просмотров по категориям
    plt.subplot(2, 2, 1)  # 2 строки, 2 столбца, 1-я часть
    ...
    plt.subplot(2, 2, 2)  # 2 строки, 2 столбца, 2-я часть
    ...
    # График общих продаж по дням за последний месяц
    plt.subplot(2, 2, 3)  # 2 строки, 2 столбца, 3-я часть
    ...
    # Визуализируем конверсию по категориям
    plt.subplot(2, 2, 4)  # 2 строки, 2 столбца, 4-я часть
